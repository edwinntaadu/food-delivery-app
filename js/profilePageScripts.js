...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    try {
      ...
      document.getElementById("user_name").textContent = result.profile.username;
      document.getElementById("user_email").textContent = result.profile.email;
      document.getElementById("user_phone").textContent = result.profile.phoneNumber || "N/A";
    } catch (error) {
